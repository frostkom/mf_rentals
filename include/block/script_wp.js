		...
		edit: function(props)
		{
			return el(
				...
				[
					...
					.show_select(array('data' => $this->get_option_types_for_select(), 'name' => $this->get_field_name('webshop_option_type'), 'text' => __("Type", 'lang_rentals'), 'value' => $instance['webshop_option_type']))
